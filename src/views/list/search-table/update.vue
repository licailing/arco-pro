    ...
    <a-form ref="formRef" layout="vertical" :model="formData">
      <a-space direction="vertical" :size="16">
        <a-card class="general-card">
          ...
          <a-row :gutter="80">
            <a-col :span="8">
              <a-form-item :label="formData.unit === 'money' ? '申请金额(万元)' : '申请金额比例'" field="money"
                :rules="[{ required: true, message: '请输入申请金额' }]">
                <InputDecimal style="width:70%;" v-model="formData.money" placeholder="请输入" :type="formData.unit"
                  capitalUnit="万元" />
                <a-select style="width:30%;" v-model="formData.unit">
            ...
            <a-col :span="8">
              <a-form-item label="申请金额(元)" field="money1" :rules="[{ required: true, message: '请输入申请金额' }]">
                <InputDecimal v-model="formData.money1" placeholder="请输入申请金额" type="money" capitalUnit="元" />
              </a-form-item>
            </a-col>
            <a-col :span="8">
              <a-form-item label="保证金比例" field="rate" :rules="[{ required: true, message: '请输入保证金比例' }]">
                <InputDecimal v-model="formData.rate" placeholder="请输入保证金比例" type="percent" />
              </a-form-item>
            </a-col>
            <a-col :span="8">
              <a-form-item label="保证金比例" field="rate1" :rules="[{ required: true, message: '请输入保证金比例' }]">
                <InputDecimal v-model="formData.rate1" placeholder="请输入保证金" type="decimal" />
              </a-form-item>
            </a-col>
            <a-col :span="8">
              <a-form-item label="文件份数" field="fileNumber" :rules="[{ required: true, message: '请输入文件份数' }]">
                <InputDecimal v-model="formData.fileNumber" placeholder="请输入文件份数" type="int" :max="100" />
              </a-form-item>
            </a-col>
            <a-col :span="8">
